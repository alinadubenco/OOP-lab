...
import Dates.Address;
import Dates.PhoneNumber;
import JClass.Department;
...
public class Hospital{
    ...
    public Hospital(String name,Address address,PhoneNumber phone,Department[] departments){
        this.name=name;
